...
7. **"Turn it off" / "disable"** → `~/.config/opencode/skills/gstack/bin/gstack-config set question_tuning false`
8. **"Turn it on" / "enable"** → `~/.config/opencode/skills/gstack/bin/gstack-config set question_tuning true`
