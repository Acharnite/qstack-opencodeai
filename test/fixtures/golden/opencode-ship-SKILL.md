...
if [ "$_VENDORED" = "no" ] && [ -d ".opencode/skills/gstack" ] && [ ! -L ".opencode/skills/gstack" ]; then
  if [ -f ".opencode/skills/gstack/VERSION" ] || [ -d ".opencode/skills/gstack/.git" ]; then
    _VENDORED="yes"
  fi
fi
